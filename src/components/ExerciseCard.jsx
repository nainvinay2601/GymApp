...
function ExerciseCard(props) {
    ...
    function handleSetIncrement(){
        ...
        // currentValue+1 and remainder of 5 and the output will be the value of setsCompleted
    }
  return (
    <div className="p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap">
      <div className="flex flex-col sm:flex-row sm:items-center sm:flex-wrap sm:gap-x-4 ">
